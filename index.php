...
<div class="min-h-screen flex items-center justify-center background-image">
    <div class="bg-gray-300 dark:bg-gray-700 p-8 rounded-lg shadow-lg overlay w-96 animate__animated animate__fadeIn">
        ...
        <input id="display" class="w-full h-16 px-4 mb-4 text-2xl result-input rounded-lg animate__animated animate__bounceIn" type="text" >
        <div class="flex items-center space-x-4">
    <label class="inline-flex items-center">
        <input type="radio" id="radians" name="angle-unit" value="radians" class="form-radio text-indigo-600">
        <span class="ml-2 text-gray-700">Radianes</span>
    </label>

    <label class="inline-flex items-center">
        <input type="radio" id="degrees" name="angle-unit" value="degrees" class="form-radio text-indigo-600">
        <span class="ml-2 text-gray-700">Grados</span>
    </label>
</div>
    ...
    <button class="btn operator-btn" id="sinButton" onclick="appendToDisplay('sin(')">sin</button>
    <button class="btn operator-btn" id="cosButton" onclick="appendToDisplay('cos(')">cos</button>
    <button class="btn operator-btn" id="tanButton" onclick="appendToDisplay('tan(')">tan</button>
